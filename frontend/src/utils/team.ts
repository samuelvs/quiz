export const team = [
  ...
  {
    name: "HELENA VIRGÍNIA DOS SANTOS NASCIMENTO",
    position: "BOLSISTA",
  ...
  },
  {
    ...
    name: "LETÍCIA RODRIGUES DOS PASSOS MELLO",
    position: "VOLUNTÁRIA",
    curriculum: "Graduanda em Ciências Biológicas, modalidade licenciatura, discente do Curso Técnico em Enfermagem, ambos na Universidade Federal da Paraíba. Realizou estágio voluntário no Parque Zoobotânico Arruda Câmara por um período aproximado de 3 meses na área de Educação Ambiental, onde atuou num projeto direcionado para a visitação guiada para crianças entre 2 a 7 anos. Participou de um projeto de Extensão na área de Histopatologia e Necropsia. Atualmente está como tutora da disciplina de Anatomia Humana na UFPB - Campus 1."
  },
  {
    name: "JESSICLEIDE DA SILVA SOARES DO NASCIMENTO",
    position: "VOLUNTÁRIA",
    curriculum: "Técnico de Enfermagem pela Universidade Federal da Paraíba CPT-ETS-UFPB . Instrumentadora Cirúrgica pelo Projeto de Extensão Instrumentação: um despertar CPT-ETS-UFPB. Curso em APH Extensionistas voluntária no projeto Imuniza UFPB. Monitora pelo projeto Vacinar para não voltar pela Fiocruz. Colaboradora da Extensão ‘SOS nas Escolas’.",
  },
  {
