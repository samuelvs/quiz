...
export const PRE_QUIZ_QUESTIONS = BASE_URL + '/api/pre-quiz-questions';
export const PRE_QUIZ_ANSWERQUESTION = PRE_QUIZ_QUESTIONS + '/pre-quiz-answer';
export const FINALIZE_PRE_QUIZ = PRE_QUIZ_QUESTIONS + '/pre-quiz-finish';
